...
namespace Thi.Controllers
{
    ...
    {
        private ThiContext db = new ThiContext();
        ...
        public ActionResult Create([Bind(Include = "EmployeeId,EmployeeName,Department,Salary")] Employee employee)
        {
            ...
            {
                var existEmployee = db.Employees.FirstOrDefault(e=>e.EmployeeId == employee.EmployeeId);
                if (existEmployee != null)
                {
                    ModelState.AddModelError("", "Exist Employee ! Please import other EmployeeId");
                    return View("Create");
                }
